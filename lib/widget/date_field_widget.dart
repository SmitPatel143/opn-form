    ...
    return FormField<String?>(
      ...
      builder: (dateFieldState) {
        return ListTile(
          ...
          subtitle: Text(dateFieldState.value ?? 'Select Date'),
          enabled: !isDisabled,
          ...
          onTap: isDisabled
              ...
              : () async {
                  ...
                  if (date != null) {
                    final formatedDate = date.toIso8601String().split('T')[0];
                    dateFieldState.didChange(formatedDate);
                    ref
                        .read(formDataProvider.notifier)
                        .updateValue(field.id!, formatedDate);
                  }
                },
        );
      },
